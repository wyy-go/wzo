...
import (
	...
	"github.com/wyy-go/wzo/core/transport"
	transportHttp "github.com/wyy-go/wzo/core/transport/http/server"
)
...
func (cy *Carry) setEncoding(e *wencoding.Encoding) {
	cy.encoding = e
}
